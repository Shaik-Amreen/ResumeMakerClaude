    ...
    <div className="min-h-screen bg-paper text-ink relative font-sans flex flex-col">
      ...
      <div className="relative z-10 flex flex-col flex-1 max-w-[1600px] w-full mx-auto p-4 md:p-6 gap-4 min-h-0">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-4 min-h-0 items-start">
          <aside className="lg:col-span-1 glass rounded-2xl flex flex-col overflow-hidden min-h-[280px] lg:sticky lg:top-[1.5vh] lg:h-[97vh] lg:max-h-[97vh]">
            <JobFiltersBar
              filters={filters}
              onChange={setFilters}
              total={jobs.length}
            ...
            />
            <div className="flex-1 overflow-y-auto overscroll-contain bg-white/60">
              {loading ? (
          ...
          <main className="lg:col-span-3 glass rounded-2xl overflow-hidden min-h-[400px] lg:sticky lg:top-[1.5vh] lg:h-[97vh] lg:max-h-[97vh] bg-white/95">
            {selected ? (
              <JobDetailPanel
                job={selected}
                onUpdated={loadJobs}
