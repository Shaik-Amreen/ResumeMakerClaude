...
export interface FaangPortalTarget {
  ...
  searchUrl: string;
  /** Extra listing URLs for the same company (scraped after searchUrl) */
...
export const FAANG_PRIORITY_PORTALS: FaangPortalTarget[] = [
  ...
  },
  {
    ...
    extraSearchUrls: [
      // AnitaB / Getro apply portal — US intern listings (single query; title/URL dedupe handles overlaps)
...
export const GITHUB_INTERNSHIP_LISTS: { name: string; rawUrl: string }[] = [
  {
