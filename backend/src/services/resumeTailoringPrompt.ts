...
export function buildResumeSystemPrompt(ctx: ResumeJobContext): string {
  ...
  return [
    ...
    'Violations that are FORBIDDEN: JD prose in Languages/Skills; inventing fake employers; dropping sections; copying template projects unchanged when they miss JD skills.',
    instructions,
    '',
    ...
    'FABRICATION ALLOWED: You are open to fabricate and generate new technical features, architectures, or scaling metrics within the existing projects (Amazon, Infobell, ASI, NativeNest, etc.) to perfectly match the JD. Never invent fake employers.',
    ...
    '□ R9/R15: adapt/fabricate project features and metrics to maximize JD match; never invent employers; no GitHub project links',
