...
export const config = {
  ...
  skipRules: {
    ...
    /** Skip known staffing mills + profile-marketing JDs (default on). */
    skipStaffingConsultancies: process.env.SKIP_STAFFING_CONSULTANCIES !== 'false',
    /** Also skip companies with zero Clearbit/Wikipedia match (default off — too aggressive). */
    skipUnverifiedCompanies: process.env.SKIP_UNVERIFIED_COMPANIES === 'true',
